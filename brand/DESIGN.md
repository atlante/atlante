...
- Typography roles: Bodoni Moda for the wordmark; Source Sans 3 for display headings and interface text; Source Serif 4 for editorial reading; JetBrains Mono for code, commands, paths, diagnostics, and the formal tagline. Bodoni is never used for body text, controls, tables, or diagnostics.
