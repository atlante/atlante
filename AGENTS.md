...
4. When writing or editing developer-facing prose — the docs site, README, guides, and package READMEs — follow the writing contract in [`CONTRIBUTING.md`](CONTRIBUTING.md) ("Write documentation") and the voice rules in `brand/DESIGN.md`. Additionally:
